...
//		outState.putAll(BundleCreator.createBundle(mapView, missionCreated,
//				trackStarted, gpsTrack, polygonTrackStarted, polygonTrack));
...
//				final ProgressDialog progressDialogTIFF = ProgressDialog.show(
//						this, getString(R.string.tiff_progress_title),
