...
/**
 * This top-level tile provider implements a basic tile request chain which
 * includes a {@link MapTileFilesystemProvider} (a file-system cache), a
 * {@link MapTileFileArchiveProvider} (archive provider), and a
 * {@link WMSMapTileDownloader} (downloads map tiles via tile source).
 * 
